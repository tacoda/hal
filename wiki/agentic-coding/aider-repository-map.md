...
engineering](../harness-engineering/memory-engineering.md): not a stale embedding index and not blind
file reads, but an **AST-derived, ranked structural summary** kept within a token
budget. It complements [Cline's discovery
approach](../harness-engineering/why-cline-doesnt-index-your-codebase.md) — where Cline follows imports
live, Aider precomputes a ranked map of the whole graph.

## Related

- [Why Cline Doesn't Index Your Codebase](../harness-engineering/why-cline-doesnt-index-your-codebase.md) — the no-index counterpart.
- [Memory Engineering](../harness-engineering/memory-engineering.md) — the code's AST as a memory substrate.
- [Context Engineering](../harness-engineering/context-engineering.md) — packing the most relevant context into the window.

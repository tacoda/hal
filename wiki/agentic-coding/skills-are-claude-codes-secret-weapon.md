...
(feedback) side in [Maintainability Sensors for Coding Agents](../harness-engineering/maintainability-sensors-for-coding-agents.md)
and fits the broader picture in [Agent Harness Engineering](../harness-engineering/agent-harness-engineering.md),

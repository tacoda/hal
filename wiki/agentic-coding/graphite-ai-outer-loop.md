...
[AI code security](../security/ai-code-security.md) and the reviewer shortage in
...
- [AI code security](../security/ai-code-security.md) — scanning the artifact before merge.
- [Automated review & verification](../harness-engineering/automated-review-verification.md) — why the
  human still owns the gate.
- [The hidden vulnerabilities behind AI code](../security/hidden-vulnerabilities-ai-code.md) —

...
- **Memory** — short-term (the state carried through one run) and long-term
  ...
  [agent memory systems](../harness-engineering/agent-memory-systems-knowledge-graphs.md).
...
[agent runtime](../ai-platform/agent-runtime.md) problem. Tools it calls are frequently exposed
via the [Model Context Protocol](../ai-platform/model-context-protocol.md).

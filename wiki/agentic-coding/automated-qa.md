...
[TDD's five practices](../software-engineering/tdd-five-practices.md) and the prove-it pattern.)
...
- [**Evals**](../ai-platform/evals-llm-as-a-judge.md) score the *agent's behavior*.
- [**Automated review**](../harness-engineering/automated-review-verification.md) checks the *diff*.
- **QA** asks the third question — does the *running software* actually do what
  it should?

Increasingly a step **inside a [loop](../harness-engineering/loop-engineering.md)** rather than a manual
...
- [Evals & LLM-as-a-Judge](../ai-platform/evals-llm-as-a-judge.md) — scores behavior, not the
  running software.
- [TDD and Its Five Supporting Practices](../software-engineering/tdd-five-practices.md) — reproducing
  tests as spec-by-example.
- [Loop Engineering](../harness-engineering/loop-engineering.md) — QA as a loop step, not a gate.

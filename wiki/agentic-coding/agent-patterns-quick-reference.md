...
The pattern vocabulary behind [Agent Harness Engineering](../harness-engineering/agent-harness-engineering.md)
and the [Loop Engineering Playbook](../harness-engineering/loop-engineering-playbook.md) (subagents = the

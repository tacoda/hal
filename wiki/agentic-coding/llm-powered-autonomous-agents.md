...
- **Long-term memory** — effectively unlimited recall via an **external vector
  ...
  large speedup. See [architecting agent memory](../harness-engineering/architecting-agent-memory.md)
  and [agent memory systems](../harness-engineering/agent-memory-systems-knowledge-graphs.md).
...
tool calling and the [Model Context Protocol](../ai-platform/model-context-protocol.md).

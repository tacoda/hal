...
- **settings.json** — configuration: **permissions** (allow/deny rules for tools
  ...
  [MCP configuration reference](../ai-platform/mcp-configuration-reference.md).
...
[context engineering](../harness-engineering/context-engineering.md); the skills and subagents pieces

...
[The Mythical Man-Month](../process-and-teams/the-mythical-man-month.md): adding people to a late project makes
...
[Cursor's Agent Swarm Built a Browser](../harness-engineering/cursor-agent-swarm-browser.md), and it rhymes with
[Loop Engineering Is Just Software Engineering](../harness-engineering/loop-engineering-is-just-software-engineering.md)

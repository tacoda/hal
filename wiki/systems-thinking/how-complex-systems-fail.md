...
post-mortem](../devops-sre/blameless-post-mortems.md) — Allspaw's "second story" is Cook's
...
resilience thinking behind [architecting for scale](../software-architecture/architecting-for-scale.md).

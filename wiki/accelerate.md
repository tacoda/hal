...
and [Software Development Metrics](software-development-metrics.md). The AI era
...
[software engineering metrics AI broke](software-engineering-metrics-ai-broke.md).
Contrast with the per-developer counting critiqued in [Codermetrics](codermetrics.md).

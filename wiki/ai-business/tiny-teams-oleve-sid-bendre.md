...
concrete data point on the [tiny teams / dark factory](../harness-engineering/dark-factory.md) thesis:
AI-native leverage lets a handful of people operate at a scale that used to need a
company. Cited as a source in [org shape & team size](../ai-org/org-shape-team-size.md).
...
- **Model taste:** Claude is notably better at human/Gen-Z-sounding text (OpenAI
  ...
  (See [models](../ai-platform/models.md), [model router](../ai-platform/model-router.md).)
...
- [Org Shape & Team Size](../ai-org/org-shape-team-size.md) — this is a primary data point for it.
- [Dark Factory](../harness-engineering/dark-factory.md) — the tiny-team / AI-native production thesis.
- [Model Router](../ai-platform/model-router.md) / [Models](../ai-platform/models.md) — contrast with their prompt-routing choice.

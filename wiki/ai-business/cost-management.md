...
The levers mostly live at the [model router](../ai-platform/model-router.md) — prompt caching,
...
- [Model Router](../ai-platform/model-router.md) — where the cost levers (caching, tiering,
  metering) physically live.
- [Calculating ROI](calculating-roi.md) — token cost is one input to the net-ROI
  number.
- [Agent Runtime](../ai-platform/agent-runtime.md) — fan-out caps bound cost as much as safety.

...
[test-driven development](test-driven-development-by-example.md); the guiding
practices overlap with the [five TDD practices](tdd-five-practices.md). It is also
a direct ancestor of today's
[specs-as-source-of-truth](the-new-code-specs-as-source-of-truth.md) and
[spec-driven development](spec-driven-development.md) thinking, where the spec is

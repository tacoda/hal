...
- **Knowing what "good" looks like is the new gold.** The scarce skill isn't
  ...
  *architecture* (does it fit?), and the *domain* (is it what the business
  needs?). Exactly the judgment [vibe coding](vibe-coding.md) sets aside — which
...
Comprehension debt is the cost that [collaborating with agents](collaborating-with-agents.md)
routes around (hand off only what's clear and low-risk) and that
[evals](evals-llm-as-a-judge.md) and reviewed, understood
[spec-driven work](spec-driven-development.md) pay down. The antidote is
...
- [Collaborating with Agents](collaborating-with-agents.md) — matching mode to
  clarity is how you avoid unchosen debt.
- [Vibe Coding](vibe-coding.md) — the deliberate surrender of comprehension;

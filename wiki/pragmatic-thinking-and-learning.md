...
you can act on tomorrow. It pairs with [The Pragmatic Programmer](the-pragmatic-programmer.md)
(same author, same pragmatic stance) and gives the cognitive backbone to the deliberate
practice described in [Learning the Craft](learning-the-craft.md).
...
[Learning the Craft](learning-the-craft.md) and the practices in

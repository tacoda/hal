...
- The pipeline's fast test stages depend on a healthy test suite: see
  [Unit Testing: Principles, Practices, and Patterns](../software-engineering/unit-testing-khorikov.md) and
  [Test-Driven Development by Example](../software-engineering/test-driven-development-by-example.md).
- "Every commit releasable" and "small safe steps" is the delivery-scale version of the
  same instinct in [Extreme Programming Explained](../process-and-teams/extreme-programming-explained.md) and
  [Tidy First?](../software-engineering/tidy-first.md).

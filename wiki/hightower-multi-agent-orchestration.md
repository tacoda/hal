...
This is [context isolation](principles-of-agentic-development.md) applied across agents. A
...
See also [from coder to orchestrator](from-coder-to-orchestrator.md) for the role shift this
implies.

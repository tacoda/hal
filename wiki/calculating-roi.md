...
- **Team-level outcomes, not individual scores** (individual metrics get gamed
  instantly — see [rethinking performance](rethinking-performance.md)).
...
- [Rethinking Performance](rethinking-performance.md) — the individual-metric
  version of the same measurement trap.
- [Driving Adoption](driving-adoption.md) — the adoption-phase dip is a line item
  in the cost stack.
- [Before AI / After AI](before-and-after-ai-bottlenecks.md) — where the real

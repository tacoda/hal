...
tokens** (contrast the accounting angle in [cost management](cost-management.md)
...
Hashimoto describes in [My AI Adoption Journey](my-ai-adoption-journey.md).
...
- **Skills** — reusable, model-legible capabilities (see [Claude Skills (Willison)](claude-skills-willison.md)).

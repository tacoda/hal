...
[learning the craft](learning-the-craft.md) argues fundamentals still have to be
taught, and it's the mechanism behind [comprehension debt](comprehension-debt.md)
and the [ironies of automation](ironies-of-automation.md).

## Related

- [Learning the Craft](learning-the-craft.md) — applies this law to AI-era
  fundamentals.
- [Does AI Make Us Stupid](does-ai-make-us-stupid.md) — cognitive offloading of
  the layer below.

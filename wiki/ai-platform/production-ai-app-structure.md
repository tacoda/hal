...
A filesystem-level realization of [Agent Harness Engineering](../harness-engineering/agent-harness-engineering.md):
...
[Four Files to Save You Two Hours a Day](../agentic-coding/four-files-ai-workflow.md).

...
When humans stop reviewing every line — the [dark factory](../harness-engineering/dark-factory.md) end
...
- [Evals & LLM-as-a-Judge](evals-llm-as-a-judge.md) — traces are the substrate
  evals sit on.
- [Dark Factory](../harness-engineering/dark-factory.md) — traceability replaces line-by-line review.
- [Six Layers for AI Governance](../ai-governance/six-layers-ai-governance.md) /
  [AI Governance by Design](../ai-governance/ai-governance-by-design.md) — the governance frame.

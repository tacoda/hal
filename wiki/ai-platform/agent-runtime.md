...
unattended. The **platform counterpart to [loop engineering](../harness-engineering/loop-engineering.md)**:
...
- [Loop Engineering](../harness-engineering/loop-engineering.md) — the practice; the runtime is where
  it executes at scale.
- [Execution Sandboxing](execution-sandboxing.md) — each run lands in a sandbox.
- [Dark Factory](../harness-engineering/dark-factory.md) — the runtime is the factory floor.

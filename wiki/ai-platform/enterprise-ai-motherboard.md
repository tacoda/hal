...
A maximalist sibling of [AI Harness Architecture](../harness-engineering/ai-harness-architecture.md) and the
[Agentic Engineering Stack](../agentic-coding/agentic-engineering-stack.md); same author's era view is
[The Mother of All Architecture Diagrams](../software-architecture/mother-of-all-architecture-diagrams.md). The

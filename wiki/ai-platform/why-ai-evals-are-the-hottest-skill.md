...
Connects to [spec-driven development](../agentic-coding/spec-driven-development.md) and the
independent-verifier principle in [loop engineering](../harness-engineering/loop-engineering.md).

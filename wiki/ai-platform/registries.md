...
[memory engineering](../harness-engineering/memory-engineering.md) (a reusable skill library needs
somewhere governed to live).

## Related

- [MCP Gateway](mcp-gateway.md) — routes to what the registry catalogs.
- [Memory Engineering](../harness-engineering/memory-engineering.md) — procedural memory = a governed
  skill library.

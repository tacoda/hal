...
- [AI Code Security](../security/ai-code-security.md) — the security trio: this guards
...
- [Six Layers for AI Governance](../ai-governance/six-layers-ai-governance.md) /
  [AI Governance by Design](../ai-governance/ai-governance-by-design.md) — the broader governance

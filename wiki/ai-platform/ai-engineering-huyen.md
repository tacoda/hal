...
[the rise of the AI engineer](../ai-org/rise-of-the-ai-engineer.md)).
...
need finetuning, and prompt discipline (compare [delete 90% of your prompt](../agentic-coding/delete-90-percent-of-your-prompt.md))
often beats it.
...
[AI engineering bookshelf](../misc/ai-engineering-bookshelf.md) and reads as the applied companion to

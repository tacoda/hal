...
- **Vibe coding for agent UX is hard.** You can't spec agent feel in advance —
  ...
  and users hated it. You only learn by feeling it. (See [vibe coding](../agentic-coding/vibe-coding.md).)
...
- **Models silently improve underneath you.** After a model upgrade, teammates
  ...
  a code change, the [METR long-task trend](../harness-engineering/measuring-ai-long-tasks.md) felt from
  the product seat.
...
expected. Ties into [from coder to orchestrator](../ai-org/from-coder-to-orchestrator.md)
and [collaborating with agents](../agentic-coding/collaborating-with-agents.md).

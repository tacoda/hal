...
- **Regression.** Context and skills are an input you keep editing, and the model
  ...
  in the [self-improving harness loop](../harness-engineering/self-improving-harness-loop.md).)
- **Pruning.** A before/after eval shows when the model already knows something
  ...
  [context window lean](../harness-engineering/context-engineering.md). *What the eval proves
...
[TDD's five practices](../software-engineering/tdd-five-practices.md) — spec-by-example, applied to

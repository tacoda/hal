...
that turns one developer's [spec](../agentic-coding/spec-driven-development.md) into a repeatable
**delivery line**:
...
As autonomous [loops](../harness-engineering/loop-engineering.md) take over the build, the lifecycle
...
operational road to the [dark factory](../harness-engineering/dark-factory.md).

## Related

- [Spec-Driven Development](../agentic-coding/spec-driven-development.md) — the spec that enters the
  pipeline.
- [Loop Engineering](../harness-engineering/loop-engineering.md) / [Dark Factory](../harness-engineering/dark-factory.md) — the

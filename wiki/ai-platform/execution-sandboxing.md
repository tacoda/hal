...
Unattended [loops](../harness-engineering/loop-engineering.md) make this **non-negotiable** — *a loop
...
- [Loop Engineering](../harness-engineering/loop-engineering.md) — unattended loops need bounded blast
  radius.
- [Harness Engineering](../harness-engineering/harness-engineering.md) — per-agent sandboxes as an
  in-practice move.
- [Guardrails Proxy](guardrails-proxy.md) — the sibling runtime safety layer
  (content/policy vs execution isolation).
- [AI Code Security](../security/ai-code-security.md) — the security trio: this contains the

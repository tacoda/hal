...
Whitenack explicitly points the audience to the [OWASP LLM Top 10](owasp-llm-top-10.md)
...
- [OWASP LLM Top 10](owasp-llm-top-10.md) — the risk taxonomy this talk mitigates
  point-by-point.
- [Guardrails Proxy](guardrails-proxy.md) — the filter-around-the-model pattern.
- [Data Governance](data-governance.md) — RAG-doxing, PII leakage, and Excessive Agency.

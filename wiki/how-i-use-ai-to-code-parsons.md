...
and [No Vibes Allowed (Dex Horthy)](no-vibes-allowed-dex-horthy.md).

## Loops do the work

Once the setup is right, the agent runs in loops (see [Ralph Wiggum, Software Engineer](ralph-wiggum-software-engineer.md)
and [Loop Engineering](loop-engineering.md)) — producing, self-checking, and continuing
...
This thread is developed in its own note, [Feedback Is the New Bottleneck](feedback-is-the-new-bottleneck.md).
...
[The AI Productivity Paradox](ai-productivity-paradox.md) and

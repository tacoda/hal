...
[vibe coding](vibe-coding.md) earns its keep — throwaway prototypes to feel out
...
[dark factory](dark-factory.md). And "product engineer" stays a **loosely
...
- [Vibe Coding](vibe-coding.md) — the discovery tool this role leans on.

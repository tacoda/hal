...
Design](../software-engineering/a-philosophy-of-software-design.md) (fight complexity as the central
enemy), [Clean Code](../software-engineering/clean-code.md) (code is read far more than it is written),
and [Code Simplicity](../software-engineering/code-simplicity.md).
...
simple" distinction in [Simple Made Easy](../software-engineering/simple-made-easy.md) — abstraction lets

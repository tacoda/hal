...
in [from coder to orchestrator](from-coder-to-orchestrator.md), and the graduated trust of
the [autonomy ladder](autonomy-ladder.md). Iterating the spec rather than the code is the
same practice as the ["maintaining the spec" loop](principles-of-agentic-development.md)

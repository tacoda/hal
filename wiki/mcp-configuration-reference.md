...
MCP is the "tool integration" layer of [Agent Harness Engineering](agent-harness-engineering.md)
and the "connectors" part of the [Loop Engineering Playbook](loop-engineering-playbook.md).
"Too many servers dilute context" echoes [CRESS](cress-context-checklist.md) (keep context small).

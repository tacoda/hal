...
[OpenLLMetry](openllmetry-is-all-you-need.md): standardize the emission, keep the backend
swappable.
...
the operational complement to [why AI evals are the hottest skill](why-ai-evals-are-the-hottest-skill.md)
and the Arize view in [agent observability, evals, and experimentation](arize-observability-evals-experimentation.md).

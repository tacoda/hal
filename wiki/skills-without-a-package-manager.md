...
This is the gap a **[registry](registries.md)** fills for other artifacts: a canonical
...
- [Registries](registries.md) — the missing distribution/versioning layer for shared assets.

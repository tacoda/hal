...
elsewhere in HAL. [Accelerate](../devops-sre/accelerate.md) explicitly draws on lean product
...
[Site Reliability Engineering](../devops-sre/site-reliability-engineering.md), and lean's
customer-value framing runs through [Effective DevOps](../devops-sre/effective-devops.md).

...
[Test-Driven Development by Example](../software-engineering/test-driven-development-by-example.md) and the
[five TDD practices](../software-engineering/tdd-five-practices.md): the specification and the test
converge into the same artifact. The
[spec-driven development](../agentic-coding/spec-driven-development.md) movement pushes this further,

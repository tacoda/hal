...
[TDD by Example](../software-engineering/test-driven-development-by-example.md) and the pragmatic
prioritization in [The Effective Engineer](../software-engineering/the-effective-engineer.md).

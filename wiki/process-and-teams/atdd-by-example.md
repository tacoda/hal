...
[unit-level TDD](../software-engineering/test-driven-development-by-example.md) up to the level of
...
[The Way of the Web Tester](../software-engineering/the-way-of-the-web-tester.md), and the broader
automation discipline is covered in [automated QA](../agentic-coding/automated-qa.md).

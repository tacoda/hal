...
DevOps — the same [Lean](lean-thinking.md) roots that feed
...
[Thinking in Systems](thinking-in-systems.md) and to why incidents cascade the way
[How Complex Systems Fail](how-complex-systems-fail.md) describes.

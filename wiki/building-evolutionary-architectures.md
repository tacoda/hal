...
- **Incremental** — change lands in small, reversible steps rather than big-bang
  ...
  [Continuous Delivery](continuous-delivery.md): a strong deployment pipeline is the
...
which is the same reflex as [test-driven development](tdd-five-practices.md) applied at
...
in [Accelerate](accelerate.md) is the payoff — teams that can change safely ship faster.

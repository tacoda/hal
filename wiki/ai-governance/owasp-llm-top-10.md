...
in [LLM Safeguards](../ai-platform/llm-safeguards.md) ("just search for llm top 10").
...
- **LLM01 / LLM02 / LLM06** motivate the [guardrails proxy](../ai-platform/guardrails-proxy.md) pattern:
...
- **LLM06 Excessive Agency** is the agentic risk — the fix is least-privilege identity
  ...
  ([Execution Sandboxing](../ai-platform/execution-sandboxing.md)), plus human-in-the-loop dry runs.
...
See [LLM Safeguards](../ai-platform/llm-safeguards.md) for a practitioner's concrete mitigations mapped
onto this list, and [AI Code Security](../security/ai-code-security.md) for the code-generation slice.

## Related

- [LLM Safeguards](../ai-platform/llm-safeguards.md) — concrete Enterprise mitigations mapped to this list.
- [Guardrails Proxy](../ai-platform/guardrails-proxy.md) — the filter-around-the-model control for
  LLM01/02/06.
...
- [Agent Identity & Access](agent-identity-access.md) and
  [Execution Sandboxing](../ai-platform/execution-sandboxing.md) — mitigations for LLM06 Excessive Agency.
- [AI Code Security](../security/ai-code-security.md) — the code-generation security surface.

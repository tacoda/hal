...
- **Routes [review](../harness-engineering/automated-review-verification.md) attention** to where it's
  needed.
...
- [Automated Review & Verification](../harness-engineering/automated-review-verification.md) — where
  provenance routes attention.
- [Agent Observability](../ai-platform/agent-observability.md) — the runtime-trace counterpart

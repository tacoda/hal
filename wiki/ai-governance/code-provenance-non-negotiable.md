...
[litellm PyPI attack](../security/litellm-pypi-supply-chain-attack.md) is a live example of code
...
- [litellm PyPI supply-chain attack](../security/litellm-pypi-supply-chain-attack.md) — unverified code entering an environment.

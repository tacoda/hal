...
controls — the policy that the [guardrails proxy](../ai-platform/guardrails-proxy.md) and
...
- [Guardrails Proxy](../ai-platform/guardrails-proxy.md) / [Agent Identity & Access](agent-identity-access.md)
  — the technical layers that *enforce* this policy.
- [AI Code Security](../security/ai-code-security.md) — the `.env` / secret-exposure overlap.

...
- [Agent observability](../ai-platform/agent-observability.md) + [agent identity](agent-identity-access.md)
...
- **Vendor incentive** — governance-platform / GRC vendors frame the bar as high
  ...
  the pipeline first** (see [AI SDLC](../ai-platform/ai-sdlc.md)) so evidence exists regardless
...
- [Agent Observability](../ai-platform/agent-observability.md) · [Agent Identity & Access](agent-identity-access.md)

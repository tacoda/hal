...
[AI code security](../security/ai-code-security.md) and
...
- [AI code security](../security/ai-code-security.md) — the "half of AI code fails security tests" and reviewer-gap evidence.
- [Automated review & verification](../harness-engineering/automated-review-verification.md) — verification catches only what you specified.

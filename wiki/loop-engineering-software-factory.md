...
- **Agent runtimes** already run loops for everyone: *"Codex runs coding tasks
  ...
  pull requests"* — the platform counterpart in [agent runtime](agent-runtime.md).
...
one Anthropic describes in [building effective agents](building-effective-agents.md).

...
- **Observability** — answers *what is actually happening* inside the thing you built,
  whether that's an agent or a [harness](harness-engineering.md). You can't improve
...
- [Harness Engineering](harness-engineering.md) — the "thing you built" being observed.

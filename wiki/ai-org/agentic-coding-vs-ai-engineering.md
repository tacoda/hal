...
- **AI engineering → hire integrators:** API fluency, systems thinking, a feel
  ...
  we know the output is good?" (See [evals](../ai-platform/evals-llm-as-a-judge.md).)
...
- [Layers of AI](../misc/layers-of-ai.md) — the technique taxonomy underneath these
  roles.
- [The AI Learning Ladder](../misc/ai-learning-ladder.md) — the skills roadmap across
  the spectrum.

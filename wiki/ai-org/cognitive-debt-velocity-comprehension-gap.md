...
- **Review as the new chokepoint:** PR volume up 29% YoY in 2026 while human review
  capacity didn't scale — [review, not generation, is now the bottleneck](../ai-platform/evals-llm-as-a-judge.md).
...
- [Evals / LLM-as-a-Judge](../ai-platform/evals-llm-as-a-judge.md) — automating the review chokepoint.

...
supervising agents requires (see [ironies of automation](../systems-thinking/ironies-of-automation.md),
...
- [From Coder to Orchestrator](from-coder-to-orchestrator.md) — the role the
  waves converge on.
- [Vibe Coding](../agentic-coding/vibe-coding.md) — the chat-coding wave named here.

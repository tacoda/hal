...
- [Rethinking Performance](rethinking-performance.md) /
  [Calculating ROI](../ai-business/calculating-roi.md) — where the team-vs-company gap shows up
  in the numbers.
- [Dark Factory](../harness-engineering/dark-factory.md) — the tiny-team endpoint taken to its limit.

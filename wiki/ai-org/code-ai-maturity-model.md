...
Model](../harness-engineering/ai-codebase-maturity-model.md), [agentic maturity
models](agentic-maturity-models.md), and the [autonomy ladder](../harness-engineering/autonomy-ladder.md).
...
- [Autonomy ladder](../harness-engineering/autonomy-ladder.md)

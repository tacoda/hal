...
orchestration end of [loop engineering](../harness-engineering/loop-engineering.md), leaning on the
[coding interfaces](../agentic-coding/coding-interfaces.md) that make running a fleet practical.
...
gates) and improve the [harness](../harness-engineering/harness-engineering.md) itself — so their
instinct for getting it *right* shapes the system instead of fighting the
workflow.

## Related

- [Loop Engineering](../harness-engineering/loop-engineering.md) — the orchestration end this describes
  as a human role.
- [Coding Interfaces](../agentic-coding/coding-interfaces.md) — the surfaces that make fleet

...
[keeping code simple](../software-engineering/code-simplicity.md) — reduce the mental load required to work with
...
[code simplicity](../software-engineering/code-simplicity.md): the best content, like the best code, is the content

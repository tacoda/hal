...
- [AI Factory Stack](ai-factory-stack.md) — the broader factory architecture.
- [From Coder to Orchestrator](from-coder-to-orchestrator.md) — the overseer/mayor/crew shift in role.

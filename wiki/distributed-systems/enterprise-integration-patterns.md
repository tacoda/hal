...
[microservice architecture](../software-architecture/microservice-architecture.md), and
[production-ready microservices](../software-architecture/production-ready-microservices.md); they sit
alongside the application-tier patterns in
[Patterns of Enterprise Application Architecture](../software-architecture/patterns-of-enterprise-application-architecture.md).

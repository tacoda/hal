...
See [HTTP query method](../distributed-systems/http-query-method.md) for how the query string layers onto
...
[Clean Architecture](../software-architecture/clean-architecture.md): keep the stable contract (here, the

...
collapsing under its own weight — the same motivation behind [Code Simplicity](../software-engineering/code-simplicity.md),
...
same principle that [Clean Architecture](../software-architecture/clean-architecture.md) formalizes with its

...
- [Built by Agents, Tested by Agents, Trusted by Whom?](built-by-agents-tested-by-agents.md) — the trust/accountability question this raises.
- [AI Factory Stack](ai-factory-stack.md) — the surrounding architecture.

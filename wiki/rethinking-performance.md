...
- **System leverage — the force multiplier (and it's countable).** How much do
  they contribute to the shared [context](context-engineering.md) and tooling
  repos (`AGENTS.md`, rules, the [harness](harness-engineering.md), the
  [evals](evals-llm-as-a-judge.md)), and improve the system itself — **educating
...
- [Context Engineering](context-engineering.md) /
  [Harness Engineering](harness-engineering.md) — the shared system that

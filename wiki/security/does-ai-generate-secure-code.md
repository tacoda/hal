...
- **The LLM must inherit the requestor's permissions, not exceed them.** If a user
  ...
  [agent identity & access](../ai-governance/agent-identity-access.md).
...
- [Guardrails proxy](../ai-platform/guardrails-proxy.md) — guarding runtime traffic, including prompt injection.
- [Agent identity & access](../ai-governance/agent-identity-access.md) — pass-through, least-privilege permissions.

...
- [**Guardrails proxy**](../ai-platform/guardrails-proxy.md) guards the agent's *runtime
  traffic*.
- [**Execution sandboxing**](../ai-platform/execution-sandboxing.md) *contains* what the agent
...
- [Guardrails Proxy](../ai-platform/guardrails-proxy.md) / [Execution Sandboxing](../ai-platform/execution-sandboxing.md)
  — the other two security surfaces.
- [Six Layers for AI Governance](../ai-governance/six-layers-ai-governance.md) — the security

...
Continue, etc.) and the model — a [guardrails proxy](../ai-platform/guardrails-proxy.md) that keeps
...
raw context never ships to a vendor. [Data Governance](../ai-governance/data-governance.md) cites it,
...
- **Identity reuse** — map K8s ServiceAccounts and OIDC claims to MCP permissions, so
  ...
  [agent identity & access](../ai-governance/agent-identity-access.md) pattern applied to tool servers.
...
a concrete instance of both the [guardrails proxy](../ai-platform/guardrails-proxy.md) and
[agent identity & access](../ai-governance/agent-identity-access.md) patterns, bearing on the OWASP risks
of [Sensitive Information Disclosure and Excessive Agency](../ai-governance/owasp-llm-top-10.md).

## Related

- [Guardrails Proxy](../ai-platform/guardrails-proxy.md) — CodeGate is a canonical local example.
- [Data Governance](../ai-governance/data-governance.md) — cites CodeGate as a local data-loss control.
- [LLM Secrets](llm-secrets.md) — the sibling local-secrets control for Claude Code.
- [Agent Identity & Access](../ai-governance/agent-identity-access.md) — mapping K8s identity to MCP
  permissions.
- [OWASP LLM Top 10](../ai-governance/owasp-llm-top-10.md) — the LLM02 / LLM06 risks this addresses.

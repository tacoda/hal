...
A hands-on curriculum for the discipline in [Agent Harness Engineering](agent-harness-engineering.md)
and the [Loop Engineering Playbook](loop-engineering-playbook.md) (plan → investigate →
...
mirrors [CRESS](cress-context-checklist.md) (keep context small) and

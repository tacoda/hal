...
[SWE-bench Verified](swe-bench-leaderboard.md)**. It's the successor to SWE-agent
...
attention** — which is exactly why the [SWE-bench leaderboard](swe-bench-leaderboard.md)
...
concrete baseline for thinking about [agent runtime](agent-runtime.md) and
[harness engineering](harness-engineering.md).

## Related

- [SWE-bench Leaderboard](swe-bench-leaderboard.md) — uses mini as the constant scaffold.
- [Agent Runtime](agent-runtime.md) — where a bash-only, stateless agent sits.
- [Harness Engineering](harness-engineering.md) — model-plus-harness, minimized.

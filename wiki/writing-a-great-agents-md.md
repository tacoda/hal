...
- **Start simple. Test it. Add detail when the agent makes mistakes.** The best
  ...
  [effective context engineering](effective-context-engineering-anthropic.md).
...
- [Context engineering](context-engineering.md) — agents.md is progressive-disclosure context.

...
Where [orchestration](from-coder-to-orchestrator.md) is the **role** shift,
...
firms up — which is why the [in-loop conductor and out-of-loop orchestrator](from-coder-to-orchestrator.md)
...
- **Hand off work that was never clear** → confident, plausible code for the
  *wrong problem*, plus [comprehension debt](comprehension-debt.md) you didn't
  choose.
...
[context engineering](context-engineering.md)) so everyone's agents behave
...
- [The Autonomy Ladder](autonomy-ladder.md) — the rungs of how much "what to do
  next" leaves your hands.
- [Context Engineering](context-engineering.md) — shared context is what keeps a

...
foundation** that the [guardrails proxy](guardrails-proxy.md) and
[agent observability](agent-observability.md) build on — *you cannot police or
...
- [Guardrails Proxy](guardrails-proxy.md) / [Agent Observability](agent-observability.md)
  — both need attributable identity to enforce and audit.
- [MCP Gateway](mcp-gateway.md) — agent identity is part of enterprise-ready MCP.

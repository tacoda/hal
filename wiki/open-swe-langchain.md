...
request. It is an open instance of the [Agent Runtime](agent-runtime.md) pattern
...
- [Agent Runtime](agent-runtime.md) — the pattern; Open SWE is named as an open
  instance alongside Codex cloud tasks and Cursor background agents.
- [Execution Sandboxing](execution-sandboxing.md) — the isolate-first boundary each
  task runs inside.
- [Loop Engineering](loop-engineering.md) — designing the loop the runtime executes.

...
[Clean Architecture](clean-architecture.md): keep policy (the model) independent of the
...
[Clean Architecture](clean-architecture.md), applied to the browser's I/O boundary.

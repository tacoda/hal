...
**map of the surrounding [pipeline](ai-sdlc.md), [evals](evals-llm-as-a-judge.md),
and [context](context-engineering.md).**
...
- **Don't skip stages.** Chasing the [dark factory](dark-factory.md) before the
...
- [The AI SDLC](ai-sdlc.md) — the pipeline a maturity model actually maps.
- [Driving Adoption](driving-adoption.md) — early-stage work; adoption % means
  little without the mechanism.
- [The Autonomy Ladder](autonomy-ladder.md) / [Dark Factory](dark-factory.md) —

...
[Designing Data-Intensive Applications](designing-data-intensive-applications.md) and the
operational concerns of [Production-Ready Microservices](production-ready-microservices.md).
...
[AI engineering bookshelf](ai-engineering-bookshelf.md) and pairs naturally with the

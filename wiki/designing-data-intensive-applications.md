...
service decomposition in [microservice architecture](microservice-architecture.md)
and [production-ready microservices](production-ready-microservices.md). Its
reliability chapters resonate with [How Complex Systems
Fail](how-complex-systems-fail.md), and its scalability material with
[architecting for scale](architecting-for-scale.md).

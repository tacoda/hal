...
throughout. This mindset is [refactoring](refactoring-improving-the-design-of-existing-code.md)
applied at architecture scale, and it leans on the same discipline as
[working effectively with legacy code](working-effectively-with-legacy-code.md): get a

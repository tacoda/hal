...
[You Don't Need Sub-Agents](../agentic-coding/you-dont-need-sub-agents.md), which makes the same
"we already solved this" move about coordination cost, and with
[Building Effective Agents (Anthropic)](../agentic-coding/building-effective-agents.md)'s emphasis on the

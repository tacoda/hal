...
2. **"Intent thinking"** — stating precisely enough what *correct* looks like
   that a [spec](../agentic-coding/spec-driven-development.md) can carry it.
...
- [The AI Factory Stack](../ai-platform/ai-factory-stack.md) — the components inside such a
  factory.
- [Five Engineering Archetypes](../ai-org/five-engineering-archetypes.md) — how roles

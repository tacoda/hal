...
- [Guardrails proxy](../ai-platform/guardrails-proxy.md), [LLM safeguards](../ai-platform/llm-safeguards.md) — deterministic controls around models.
- [OWASP LLM Top 10](../ai-governance/owasp-llm-top-10.md) — why the action boundary matters for security.
- [Execution sandboxing](../ai-platform/execution-sandboxing.md) — the complementary control on *effects*, where validators gate *inputs*.

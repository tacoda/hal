...
This reframes the "orchestrator" shift in [From Coder to Orchestrator](../ai-org/from-coder-to-orchestrator.md)
and [Five Engineering Archetypes (Boris Cherny)](../ai-org/five-engineering-archetypes.md) as a
...
[AI Won't Kill Junior Devs](../ai-org/ai-wont-kill-junior-devs.md) and
[Revenge of the Junior Developer](../ai-org/revenge-of-the-junior-developer.md): if the middle loop

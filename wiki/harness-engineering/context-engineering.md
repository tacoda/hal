...
- The codebase is part of the budget: SonarSource's 660-trial study — agents on
  ...
  [before/after AI bottlenecks](../ai-org/before-and-after-ai-bottlenecks.md).)
...
- Split one giant prompt or `AGENTS.md` (see
  [four-files workflow](../agentic-coding/four-files-ai-workflow.md)) into pieces loaded
...
- [Delete 90% of your prompt](../agentic-coding/delete-90-percent-of-your-prompt.md) — modern

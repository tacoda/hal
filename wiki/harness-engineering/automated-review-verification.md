...
replaces them** — the gate the [eval service](../ai-platform/evals-llm-as-a-judge.md) runs and
...
- [**Automated QA**](../agentic-coding/automated-qa.md) asks whether the *running software* works.

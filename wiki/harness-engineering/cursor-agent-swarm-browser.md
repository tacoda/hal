...
is Anthropic's [orchestrator-workers](../agentic-coding/building-effective-agents.md) pattern plus
...
- **From assisting to owning projects.** Both companies frame this as a near
  ...
  [from coder to orchestrator](../ai-org/from-coder-to-orchestrator.md), the automation

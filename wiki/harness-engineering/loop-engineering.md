...
[agent patterns quick reference](../agentic-coding/agent-patterns-quick-reference.md) for the RALPH
...
- **The loop cannot use the generating model as its own quality gate** —
  ...
  agent grades its own homework. See [evals & LLM-as-a-judge](../ai-platform/evals-llm-as-a-judge.md)

...
Same core as [TDD: Unit Tests and Hexagonal Boundaries](../software-engineering/tdd-unit-tests.md) — the test
boundary sits at these ports, which is what makes refactoring safe. Modular architecture
is one of the practices around [TDD](../software-engineering/tdd-five-practices.md).

...
discipline in [the five practices of TDD](../software-engineering/tdd-five-practices.md) and sit inside the
broader pursuit of software craftsmanship in [learning the craft](../ai-org/learning-the-craft.md).

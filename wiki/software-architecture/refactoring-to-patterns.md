...
[Refactoring](../software-engineering/refactoring-improving-the-design-of-existing-code.md) and the Gang of
...
[Refactoring](../software-engineering/refactoring-improving-the-design-of-existing-code.md) and its
language-specific companion
[Refactoring: Ruby Edition](../software-engineering/refactoring-ruby-edition.md); it depends on the vocabulary
of [Design Patterns](design-patterns-gof.md); it presumes the test safety net that
[Test-Driven Development](../software-engineering/tdd-five-practices.md) provides (you cannot refactor
confidently without tests); and it advances the same "keep it clean, let structure
emerge" ethic argued in [Clean Code](../software-engineering/clean-code.md).

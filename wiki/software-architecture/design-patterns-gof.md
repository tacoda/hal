...
- **Program to an interface, not an implementation.** Depend on abstract types, not
  ...
  [Parnas information hiding](../software-engineering/parnas-decomposing-systems-into-modules.md) applied at the
  class level.
...
- [Parnas — Decomposing Systems into Modules](../software-engineering/parnas-decomposing-systems-into-modules.md)
  — "program to an interface" is information hiding at the class boundary.
- [Refactoring: Improving the Design of Existing Code](../software-engineering/refactoring-improving-the-design-of-existing-code.md)
  — Fowler's refactorings often move code *toward* these patterns in small steps.
- [Clean Code](../software-engineering/clean-code.md) and [Clean Architecture](clean-architecture.md) — build on
...
- [A Philosophy of Software Design](../software-engineering/a-philosophy-of-software-design.md) — cautions

...
Related notes in HAL: [Governance.md Guide](../misc/governance-md-guide.md),
[Writing a Great AGENTS.md](../agentic-coding/writing-a-great-agents-md.md),
[Documenting Architecture Decisions](../software-architecture/documenting-architecture-decisions.md),
[The New Code: Specs as Source of Truth](../agentic-coding/the-new-code-specs-as-source-of-truth.md).

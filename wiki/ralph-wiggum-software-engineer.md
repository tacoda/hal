...
Related patterns: [agent patterns quick reference](agent-patterns-quick-reference.md),
[execution sandboxing](execution-sandboxing.md), [dark factory](dark-factory.md).
